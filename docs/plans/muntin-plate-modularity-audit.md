...
| **Invoices + Recipes** | E1 vendor-vs-market (wired end-to-end), E2 per-recipe + digest, recost hero loop, `/cost`, **✅ E4 silent-bleed, E5 blast-radius, E6 margin-map, E15 cost-history (`/:id/cost-history`) — all routed** | E9 learned-yield (V2) | E9 (needs learned yields persisted) |
