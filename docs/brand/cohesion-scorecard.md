...
| **Total** | **27 / 30** | Eight dimensions gated at 3 (spine, single-accent, palette, OG, contrast, mark geometry, cross-seam). Remaining: voice (4), naming (5) — and doc currency (10), ungateable by nature. |
