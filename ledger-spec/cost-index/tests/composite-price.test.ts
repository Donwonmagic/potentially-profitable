/**
 * composite-price.test.ts — VERBATIM port of tools/_shared/composite-price.test.mjs.
 * Parity guarantee for the Cost Index core. Keep in lockstep with the storefront.
 */
