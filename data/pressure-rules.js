 ...
 * Sets window.MUNTIN_PRESSURE_RULES; loaded same-origin so the Pressure Lab stays no-fetch.
 */
(function (root) {
  'use strict';
  var RULES = {
  ...
  if (typeof self !== 'undefined') self.MUNTIN_PRESSURE_RULES = RULES;
  if (root) root.MUNTIN_PRESSURE_RULES = RULES;
