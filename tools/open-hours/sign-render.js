...
(function(){
  ...
  function renderOpenHoursCard(opts) {
    ...
    ctx.textBaseline = 'middle';
    ctx.textAlign = 'left';
    ctx.fillText(strings.cardFooterLeft, 24, CARD_H - 30);
  ...
  var DEFAULT_STRINGS_EN = {
    ...
    cardFooterLeft: 'Generated by Open Hours',
    cardFooterRight: 'muntin.digital/tools/open-hours/'
  };
  ...
  var DEFAULT_STRINGS_ES = {
    ...
    date: new Date().toISOString().slice(0, 10),
    brand: 'Muntin Digital',
    cardFooterLeft: 'Generado con Horario Abierto',
    cardFooterRight: 'muntin.digital/es/tools/open-hours/'
  };
