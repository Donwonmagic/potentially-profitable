...
var RESTAURANT_PRIORITY_CHECKS = [
  ...
  },
  {
    ...
    failNote: 'Your site declares hours in schema but not for every day of the week. Google falls back to a "hours vary" hint, which hurts click-through from "restaurants open now" searches. Add an openingHoursSpecification entry for every day of the week in your JSON-LD block (closed days can have opens/closes set to null). <a href="/tools/store-hours/" style="color:var(--teal);font-weight:600;">Generate it with Open Hours →</a>',
    failNote_es: 'Tu sitio declara horarios en schema pero no para cada día de la semana. Google cae al mensaje "los horarios varían", lo que reduce el click-through en búsquedas de "restaurantes abiertos ahora". Agrega una entrada openingHoursSpecification para cada día de la semana en tu bloque JSON-LD (los días cerrados pueden tener opens/closes en null). <a href="/es/tools/store-hours/" style="color:var(--teal);font-weight:600;">Genéralo con Open Hours →</a>',
    unverified: 'We couldn\'t confirm schema hours',
    unverified_es: 'No pudimos confirmar los horarios del schema',
    unverifiedNote: 'Your schema markup didn\'t declare opening hours at all (or we couldn\'t read it). Adding a complete openingHoursSpecification block is one of the highest-impact single edits you can make for local-search click-through. <a href="/tools/store-hours/" style="color:var(--teal);font-weight:600;">Generate it with Open Hours →</a>',
    unverifiedNote_es: 'Tu schema no declaró horarios en absoluto (o no pudimos leerlo). Agregar un bloque openingHoursSpecification completo es una de las ediciones individuales de mayor impacto que puedes hacer para el click-through en búsqueda local. <a href="/es/tools/store-hours/" style="color:var(--teal);font-weight:600;">Genéralo con Open Hours →</a>'
  },
