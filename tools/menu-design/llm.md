...
> (14, 27, 53). 31 cuisine-specific themes. Exports print
...
BRF Grade-1 braille — from one source. 31 curated themes
...
- You want unlimited typographic customization. The tool ships 31
...
3. **Pick a theme + paper**: 31 themes by cuisine. 22 paper
...
## Theme registry (31 themes; all free)
...
## Allergen regimes (5 supported)

- **United States — FDA Big 9** (`us-fda9`) — 9 mandatory allergens
- **European Union — FIC 1169/2011 (14 allergens)** (`eu-fic14`) — 14 mandatory allergens
- **United Kingdom — PPDS (Natasha’s Law)** (`uk-ppds`) — 14 mandatory allergens
- **Canada — Health Canada priority allergens** (`ca-health`) — 10 mandatory allergens
- **Australia / NZ — FSANZ Standard 1.2.3** (`au-fsanz`) — 10 mandatory allergens

US FDA Big 9 = 9 allergens. EU FIC 14 = 14
...
Catalog totals: 17 codes (14 legal
allergens, 2 dietary preferences, 1
