...
const SEED = {
  ingredients: [
    { key: 'ribeye', label_en: 'Ribeye', label_es: 'Ribeye', unit_en: 'lb', unit_es: 'libra',
      assessment: { asOf: '2026-06-17', confidence: 'medium', level: { basis: 'wholesale', medianCents: 1277 } } },
    ...
    { key: 'veg-oil', label_en: 'Vegetable oil', label_es: 'Aceite', unit_en: 'lb', unit_es: 'libra',
      assessment: { asOf: '2026-06-16', confidence: 'medium', level: { basis: 'index', medianCents: 35000 } } }
  ]
};
