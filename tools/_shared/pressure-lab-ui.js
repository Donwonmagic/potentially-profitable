...
(function () {
  ...
  var INDICATOR_NAME = {
    ...
    'onion-shipments': L('Shipment volume', 'Volumen de envíos'),
    'lettuce-shipments': L('Shipment volume', 'Volumen de envíos'),
    'tomato-shipments': L('Shipment volume', 'Volumen de envíos'),
    'potato-shipments': L('Shipment volume', 'Volumen de envíos'),
    'onion-imports': L('Import share', 'Cuota de importación'),
    'lettuce-imports': L('Import share', 'Cuota de importación'),
    'tomato-imports': L('Import share', 'Cuota de importación'),
    'potato-imports': L('Import share', 'Cuota de importación'),
    'onion-pace': L('Shipments vs last year', 'Envíos vs. año pasado'),
    'lettuce-pace': L('Shipments vs last year', 'Envíos vs. año pasado'),
    'tomato-pace': L('Shipments vs last year', 'Envíos vs. año pasado'),
    'potato-pace': L('Shipments vs last year', 'Envíos vs. año pasado'),
