/**
 * Unit tests — tools/_shared/observation-quality.js
 * Run via:  node --test tools/_shared/observation-quality.test.mjs
 *
 * PARITY GUARANTEE. Mirrored verbatim by Muntin Ledger at
 * apps/api/tests/cost-index/observation-quality.test.ts. The garbage-in
 * defense: a poisoned obs LOWERS confidence, never silently moves a number.
 */
