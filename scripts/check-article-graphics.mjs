...
const HISTORICAL_WAIVERS = [
  ...
  { path: 'es/library/que-debe-tener-un-sitio-web-de-restaurante',                  rule: 2, why: '2026-05-28 — ES translation sweep pending; rule 5 closed via rust accent on bad-state steps; rule 2 (variety, only viz-flow) still pending' },
