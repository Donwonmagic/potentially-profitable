...
const LABELS = {
  en: {
    ...
    fillItIn: 'Fill it in',
    sheetIntro: 'Type your numbers — the math runs in your browser. Print it, export to CSV, or save it to the Workbench.',
    actions: 'Sheet actions',
    print: 'Print',
    downloadCsv: 'Download CSV',
    copy: 'Copy as text',
    reset: 'Reset',
    savePrompt: 'Save this sheet to your Workbench so you can pull it up next month.',
