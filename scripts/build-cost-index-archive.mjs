...
const COPY = {
  en: {
    ...
    lang: 'en-US',
    title: 'Cost Index — weekly edition archive | Muntin Digital',
    ...
    eyebrow: 'Cost Index · Weekly archive',
    h1: 'Every weekly edition',
    lede: 'The Restaurant Cost Index publishes one dated dispatch a week — where the weighted basket stands, what is flashing a re-price or watch signal, and the driver context behind it. This is the full run, newest first. Each edition is a permanent, citable record; the native editions ship an open per-week dataset alongside the read.',
    crumbHome: 'Home', crumbCi: 'Cost index', crumbHere: 'Weekly archive',
  ...
  es: {
    ...
    lang: 'es-US',
    title: 'Índice de costos — archivo de ediciones semanales | Muntin Digital',
    desc: 'Cada edición semanal del Índice de costos: la canasta, la confianza y enlaces a cada despacho y sus datos abiertos. Precios mayoristas públicos.',
    eyebrow: 'Índice de costos · Archivo semanal',
    h1: 'Todas las ediciones semanales',
    lede: 'El Índice de costos de restaurantes publica un despacho fechado por semana: dónde se ubica la canasta ponderada, qué activa una señal de reprecio o de vigilancia, y el contexto de los factores detrás. Esta es la serie completa, de la más reciente a la más antigua. Cada edición es un registro permanente y citable; las ediciones nativas incluyen un conjunto de datos abierto por semana junto a la lectura.',
    crumbHome: 'Inicio', crumbCi: 'Índice de costos', crumbHere: 'Archivo semanal',
