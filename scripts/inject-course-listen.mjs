...
function buildListenButton(locale) {
  ...
  return [
    ...
    `        <button type="button" id="listen-btn" class="listen-btn" aria-pressed="false" data-state="idle" data-audio-src="audio.mp3" data-audio-source-lang="${locale}" data-audio-languages="en,es">`,
