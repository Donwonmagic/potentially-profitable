...
const CHECKS = [
  ...
  // 2026-07-28: the Open the Doors course + Workshop-Kit method line was
  // retired (pages 301 to /cost-index/); its 17 gates/injectors were removed
  // with the subsystem. See docs/handoff + the retirement PR.
