...
const CHECKS = [
  ...
  // RE-ENABLED 2026-07-28: §4 "sea-why" is rendered again by inject-seasonality-why.mjs
  // (the ADR-019 mechanism layer, rebuilt as an injector over the surviving
  // scripts/lib/seasonality-fusion.mjs after the #523 merge dropped the engine render).
  ['Seasonality why self-test','inject-seasonality-why.mjs','--self-test'],
  ['Seasonality why in sync','inject-seasonality-why.mjs','--check'],
