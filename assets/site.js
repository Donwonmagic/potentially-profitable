  ...
  (() => {
    ...
    const COMMON_QUERY_REDIRECTS = {
      en: {
        ...
        'restaurant':  { label: 'The Cost Index',          href: '/cost-index/'                  },
        'restaurants': { label: 'The Cost Index',          href: '/cost-index/'                  },
      ...
      es: {
        ...
        'restaurante':    { label: 'El Índice de Costos',         href: '/es/cost-index/'                   },
        'restaurantes':   { label: 'El Índice de Costos',         href: '/es/cost-index/'                   },
